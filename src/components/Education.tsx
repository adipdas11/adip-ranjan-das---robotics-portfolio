...
const education = [
  ...
  },
  {
    ...
    period: '2021 - 2022',
    description: 'Specialized in robot control systems, computer vision, and autonomous navigation. Graduated with Distinction.',
  ...
  },
  {
    ...
    location: 'Bristol, United Kingdom',
    period: '2022 - Present',
    description: 'Research focusing on advanced robotic manipulation, dual-arm coordination, and human-robot interaction. Recipient of the Bristol Plus Award.',
